...
You can either configure Neovim yourself or use a pre-configured setup like [LazyVim](https://www.lazyvim.org/). I ended up choosing LazyVim and even wrote a [post](https://arthur.malumian.dev/blog/i-switched-to-lazyvim/) about why.
